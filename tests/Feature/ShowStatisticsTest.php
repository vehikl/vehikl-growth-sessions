...
class ShowStatisticsTest extends TestCase
{
    ...
    public function testItReturnsStatisticsForAllUsersInTheSystem()
    {
        $this->setTestNowToASafeWednesday();

        [$owner, $attendee, $nonParticipant] = User::factory()->vehiklMember()->count(3)->create();
    ...
    public function makeGrowthSessionWithSingleAttendee(
        User $attendee,
        User $owner,
