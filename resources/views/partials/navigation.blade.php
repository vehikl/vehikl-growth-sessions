<nav class="bg-gray-900 px-6 py-2">
    <div class="flex items-center justify-between flex-wrap">
        <div class="flex items-center flex-shrink-0 mr-6 sm:text-lg text-white hover:text-orange-200">
        ...
        <div
            ...
            <div class="text-xl justify-center items-center flex flex-col lg:flex-row">
                ...
                @endauth
                <a href="{{route('about')}}"
                   class="mt-4 lg:mt-0 sm:ml-6 text-white hover:text-orange-200 tracking-wider">About
                </a>
            </div>
        </div>
    </div>
