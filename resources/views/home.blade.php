...
@section('content')
    ...
    <div class="bg-gray-800">
        ...
        <section class="flex flex-col lg:flex-row px-6 sm:px-24 pt-8 pb-12 justify-between text-gray-100 bg-gray-600">
            <div class="text-center py-16 h-64">
                ...
                <a class="inline-block transform hover:-skew-y-2 hover:text-5xl bg-gray-600 border-4 border-white hover:bg-gray-700 focus:bg-gray-700 text-white text-2xl font-bold py-2 px-4 mt-2"
                target="_blank"
            ...
            <div class="text-center py-16 h-64">
                ...
                <p class="inline-block transform hover:-skew-y-2 hover:text-5xl bg-gray-600 border-4 border-white hover:bg-gray-700 focus:bg-gray-700 text-white text-2xl font-bold py-2 px-4 mt-2">
