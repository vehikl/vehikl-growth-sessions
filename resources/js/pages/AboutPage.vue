    ...
    <div class="gs-page min-h-screen">
        <section class="mx-auto max-w-6xl px-6 py-16 sm:px-8 sm:py-20">
            ...
            <div class="flex items-center gap-3">
                <span class="gs-accent-text text-xs font-semibold tracking-[0.18em] uppercase">About</span>
                <span
            ...
            <!-- Chat card -->
            <div class="gs-card gs-border mt-10 rounded-2xl border p-6 shadow-sm sm:p-8">
                <div class="space-y-5">
                    <div
            ...
            <!-- Highlight quote -->
            <blockquote
                class="border-vehikl-orange/20 from-vehikl-orange/12 to-vehikl-orange/5 relative mt-8 overflow-hidden rounded-2xl border bg-linear-to-br p-8 sm:p-10"
            >
                <i class="fa fa-quote-right gs-accent-text absolute top-6 right-6 text-xl opacity-25" aria-hidden="true"></i>
                <p class="gs-text-strong max-w-4xl text-xl leading-relaxed font-medium tracking-wide italic sm:text-2xl">
                    Growth Sessions are our time to sharpen the saw — and maybe discover the chainsaw along the way. A space for experimenting,
                    getting unstuck, learning from each other, and sharing what we've found.
                </p>
            </blockquote>
