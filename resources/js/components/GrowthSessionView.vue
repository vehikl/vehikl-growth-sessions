...
<template>
    <div class="max-w-5xl px-4">
        <div class="">
            ...
            <h2 class="text-2xl lg:text-3xl font-sans font-light">
                {{ growthSession.title }}
            </h2>
            <div>
                <v-button
        ...
        <div class="">
            ...
            <div class="mb-3">
                <h3 class="text-2xl font-sans font-light text-blue-700">Host:</h3>
                <span>{{ growthSession.owner.name }}</span>
            </div>

            <div class="mb-3">
                <h3 class="text-2xl font-sans font-light text-blue-700">Location:</h3>
            ...
            <div class="mb-3">
                <h3 class="text-2xl font-sans font-light text-blue-700">MobTime:</h3>
                <a :href="mobtimeUrl" target="_blank">{{ mobtimeUrl }}</a>
            </div>

            <div class="mb-3">
                <h3 class="text-2xl font-sans font-light text-blue-700">Time:</h3>
                <span class="mr-2">{{ date }}</span>
                <span class="whitespace-no-wrap">( {{ time }} )</span>
            </div>

            <div class="mb-3" v-if="growthSession.attendee_limit">
                <h3 class="text-2xl font-sans font-light text-blue-700">Attendee Limit:</h3>
