...
<template>
    <div class="max-w-5xl text-sky-600">
        <div class="mb-8 flex flex-col lg:flex-row lg:justify-between items-center">
            ...
            <h2 class="text-2xl lg:text-3xl font-sans font-light flex items-center text-sky-700">
        ...
        <div class="flex flex-col lg:flex-row flex-wrap">
            <div class="flex-1 mr-2 max-w-5xl">
                <h3 class="text-2xl font-sans font-light mb-3 text-sky-700">Topic</h3>
            ...
            <div class="flex-none max-w-md">
                <div class="mb-3">
                    <h3 class="text-2xl font-sans inline font-light mr-3 text-sky-700">Host:</h3>
                    <span>{{ growthSession.owner.name }}</span>
                </div>

                <div class="mb-3">
                    <h3 class="text-2xl font-sans inline font-light mr-3 text-sky-700">Location:</h3>
                ...
                <div v-if="growthSession.anydesk" class="mb-3">
                    <h3 class="text-2xl font-sans inline font-light mr-3 text-sky-700">AnyDesk:</h3>
                    <span>{{ growthSession.anydesk.name }}: {{ growthSession.anydesk.remote_desk_id }}</span>
                </div>
                <div class="mb-3">
                    <h3 class="text-2xl font-sans inline font-light mr-3 text-sky-700">MobTime:</h3>
                    <a :href="mobtimeUrl" target="_blank">{{ mobtimeUrl }}</a>
                </div>

                <div class="mb-3">
                    <h3 class="text-2xl font-sans inline font-light mr-3 text-sky-700">Time:</h3>
                    <span class="mr-2">{{ date }}</span>
                    <span class="whitespace-no-wrap">( {{ time }} )</span>
                </div>

                <div class="mb-3" v-if="growthSession.attendee_limit">
                    <h3 class="text-2xl font-sans inline font-light mr-3 text-sky-700">Attendee Limit:</h3>
                    <span class="attendee_limit">{{ growthSession.attendee_limit }}</span>
                </div>

                <h3 class="text-2xl font-sans font-light mb-3 text-sky-700">Attendees</h3>
                <ul>
                ...
                <h3 v-if="growthSession.watchers.length" class="text-2xl font-sans font-light mb-3 text-sky-700">
                    Watchers</h3>
                <ul>
