...
<template>
    <fieldset class="gs-seg flex flex-none rounded-lg p-[3px]">
        <label
            ...
            :key="option.id"
            class="transition-smooth has-[:focus-visible]:ring-gs-accent cursor-pointer rounded-md px-3 py-2 text-xs font-semibold whitespace-nowrap has-[:focus-visible]:ring-2 sm:px-4 sm:text-sm"
