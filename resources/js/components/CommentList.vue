    ...
    <div>
        <form @submit.prevent="createNewComment" class="flex">
            ...
            <textarea
                ...
                rows="3"></textarea>
            <button
                class="bg-sky-500 hover:bg-sky-700 text-white text-xl font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        ...
        <ul class="mt-6">
            <li v-for="comment in growthSession.comments" :key="comment.id" class="flex py-4 border-b border-sky-200">
                ...
                <div class="flex-1 mx-6">
                    ...
                    <div class="text-sky-400 text-sm" v-text="comment.time_stamp"></div>
