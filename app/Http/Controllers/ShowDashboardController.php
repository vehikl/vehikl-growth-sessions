...
class ShowDashboardController extends Controller
{
    ...
    {
        return Inertia::render('Dashboard', ['hosted_sessions' => $this->hostedSessions($request)]);
    }
    ...
    private function hostedSessions(Request $request): LengthAwarePaginator
    {
        ...
        return $user->sessionsHosted()
            ->with('tags')
            // The attendees relationship spans the owner pivot role too, so an unconstrained count
