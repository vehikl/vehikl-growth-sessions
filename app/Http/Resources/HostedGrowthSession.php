...
/**
 * A single row of the Dashboard's hosted Growth Sessions table.
 *
 ...
 *
 * Dates and times are formatted here rather than in the browser so the table renders plain
...
class HostedGrowthSession extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'date_label' => $this->resource->date->format('D, M j, Y'),
            'time_label' => sprintf(
                '%s – %s',
